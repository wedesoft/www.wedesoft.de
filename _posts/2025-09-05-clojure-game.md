...
You can find the source code on Github: [github.com/wedesoft/sfsim](https://github.com/wedesoft/sfsim).
Currently there is only a playtest build, but if you want to get notified, when the game gets released, you can wishlist it here: [store.steampowered.com/app/3687560/sfsim/](https://store.steampowered.com/app/3687560/sfsim/).
